...
public class SpringFoxConfig implements WebMvcConfigurer {
	...
	public Docket apiDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.ignoredParameterTypes(
						...
						//Classes abaixo foram adicionadas após adicionar o multipart 
						//como parametro no metodo de atualizar foto
						URL.class,
						URI.class,
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				...
				.version("1")
				.contact(new Contact("AlgaWorks", "http://algaworks.com.br", "contato@algaworks.com.br"))
				.build();
	}	
	...
	private List<ResponseMessage> globalGetResponseMessage(){
		return Arrays.asList(
				...
				new ResponseMessageBuilder()
					...
					.message("Recurso não possui representação que poderia ser aceita pelo servidor")
					.build(),
					new ResponseMessageBuilder()
