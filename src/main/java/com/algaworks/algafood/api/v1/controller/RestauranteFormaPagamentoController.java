...
public class RestauranteFormaPagamentoController implements RestauranteFormaPagamentoControllerOpenApi {
	...
	public CollectionModel<FormaPagamentoModel> listar(@PathVariable Long restauranteId) {
		 ...
		 if (algaSecurity.podeGerenciarFuncionamentoRestaurantes(restauranteId)) {
			 formasPagamentoModel.add(algaLinksHelper.linkToRestauranteFormaPagamentoVincular(restauranteId, "vincular"));
			 
			 formasPagamentoModel.getContent().forEach(formaPagamentoModel -> {
				 formaPagamentoModel.add(algaLinksHelper
						 .linkToRestauranteFormaPagamentoDesvincular(restauranteId, formaPagamentoModel.getId()));
			 });
		 }
	...
	public ResponseEntity<Void> vincular(@PathVariable Long restauranteId, @PathVariable Long formaPagamentoId) {
		cadastroRestaurante.vincularFormaPagamento(restauranteId, formaPagamentoId);
	...
	public ResponseEntity<Void> desvincular(@PathVariable Long restauranteId, @PathVariable Long formaPagamentoId) {
		cadastroRestaurante.desvincularFormaPagamento(restauranteId, formaPagamentoId);
		return ResponseEntity.noContent().build();
	}	
